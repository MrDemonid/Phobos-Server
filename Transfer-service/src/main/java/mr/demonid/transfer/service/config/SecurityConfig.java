...
public class SecurityConfig {
    ...
    /**
     * Активируем свой перехватчик Feign-запросов, для вставки в них jwt-токенов.
     */
    @Bean
    public RequestInterceptor feignClientInterceptor(OAuth2TokenService tokenService) {
     ...
     * Доступ:
     *      Только роли "SERVICE" с правами "SCOPE_read" или "SCOPE_write".
     */
    @Bean
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/transfer/**")
                            .access(new WebExpressionAuthorizationManager("hasRole('SERVICE') and hasAnyAuthority('SCOPE_read', 'SCOPE_write')"))
