...
import mr.demonid.rs232dev.service.dto.CustomTokenResponse;
...
public class OAuth2TokenService {
    ...
    public String getAccessToken() {
        ...
        CustomTokenResponse response = this.webClient.post()
                .uri("/oauth2/token")
                ...
                .retrieve()
                .bodyToMono(CustomTokenResponse.class)                      // преобразуем ответ в OAuth2AccessTokenResponse
